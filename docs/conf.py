...
htmlhelp_basename = 'zopeindexdoc'
...
latex_documents = [
  ('index', 'zopeindex.tex', 'zope.index Documentation',
...
man_pages = [
    ('index', 'zopeindex', 'zope.index Documentation',
...
texinfo_documents = [
  ('index', 'zopeindex', 'zope.index Documentation',
   'Zope Foundation and Contributors', 'zopeindex', 'One line description of project.',
   'Miscellaneous'),
]
